...
- Name: e2e/chat-layout-settings.spec.ts >> chat workspace keeps fixed viewport and supports sidebar mode switches
- Location: tests/e2e/chat-layout-settings.spec.ts:4:1
